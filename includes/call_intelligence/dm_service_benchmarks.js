// includes/call_intelligence/dm_service_benchmarks.js
module.exports = (companyId, projectId, rawDataset) =>
  publish("dm_service_benchmarks", {
    type: "table",
    database: projectId,
    schema: "gold",
    description: "Historical financial benchmarks table calculated 100% from ServiceTitan invoicing for deterministic valuation",
    tags: ["gold", "call_intelligence", "benchmarks", "dm_service_benchmarks"]
  })
    .query(`
