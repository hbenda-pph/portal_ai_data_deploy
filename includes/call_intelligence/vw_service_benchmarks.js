// includes/call_intelligence/vw_service_benchmarks.js
module.exports = (companyId, projectId, rawDataset) =>
  publish("vw_service_benchmarks", {
    type: "view",
    database: projectId,
    schema: "gold",
    description: "Historical financial benchmarks view calculated dynamically from ServiceTitan invoicing for real-time valuation",
    tags: ["gold", "call_intelligence", "benchmarks", "vw_service_benchmarks"]
  })
    .query(`
  WITH invoice_categorized AS (
    ...
    FROM \`${projectId}.silver.vw_invoice\`
