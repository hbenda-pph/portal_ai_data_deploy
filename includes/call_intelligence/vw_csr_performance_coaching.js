// includes/call_intelligence/vw_csr_performance_coaching.js
module.exports = (companyId, projectId, rawDataset) =>
  publish("vw_csr_performance_coaching", {
    type: "view",
    database: projectId,
    schema: "gold",
    description: "CSR performance and AI coaching recommendation view based on qualified bookable opportunities (Action Motor 2)",
    tags: ["gold", "call_intelligence", "vw_csr_performance_coaching"],
  ...
  WITH agent_aggregations AS (
    ...
    FROM \`${projectId}.gold.vw_call_intelligence\`
