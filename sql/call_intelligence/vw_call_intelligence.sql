-- =============================================================================
-- PORTAL AI DATA DEPLOY: CALL INTELLIGENCE (VIEW)
-- Target: gold.vw_call_intelligence
-- Description: Real-time canonical call intelligence view reconciling ServiceTitan 
--              calls, jobs, customer data, and Gemini AI transcriptions in live mode.
-- =============================================================================
...
enriched AS (
  ...
  LEFT JOIN `shape-mhs-1.gold.vw_service_benchmarks` bm ON t.service_requested_category = bm.service_category
)
