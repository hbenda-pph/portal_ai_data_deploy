...
-- Target: gold.dm_service_benchmarks
-- Description: Historical financial benchmarks table calculated 100% from 
--              ServiceTitan invoicing (silver.vw_invoice) for deterministic valuation.
-- =============================================================================
